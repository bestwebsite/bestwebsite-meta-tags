        ...
        <table class="widefat striped">
            <thead>
                <tr>
                    ...
                    // meta tag groups
                    foreach ($bestwebsite_meta_tag_list as $item => $details){
                        echo '<th>'. $item .' 
            ...
            <?php
                ...
                $items = bestwebsite_Retrieve_List::get_list( $type, $items_per_page, $offset );
                
                $taginfo = new bestwebsite_Retrieve_Tags( $bestwebsite_meta_tag_list );
                    ...
                    foreach ( $items['list'] as $item ){
                        ...
                        <tr>
                            ...
                            foreach ($statuses as $group => $status){
                                ...
                                $var = $bestwebsite_meta_tag_list[$group]['var'];
            ...
            <tfoot>
                ...
                // always autopilot buttons
                    ...
                    foreach ($bestwebsite_meta_tag_list as $group => $info){
                        ...
                        if ( $group != 'Custom' ){
                            ...
                            if ( 
                                !empty($bestwebsite_autopilot_settings) &&
